...
function Hero() {
  return (
    <header className=" bg-hero bg-center bg-cover bg-no-repeat sm:p-16 py-16 px-8 ">
      <div className="container flex justify-center lg:items-center max-lg:flex-col w-full sm:gap-16 gap-0 mx-auto">
